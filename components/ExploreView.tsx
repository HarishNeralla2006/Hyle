    ...
    return (
        <div className="w-full h-full flex flex-col relative font-sans text-slate-200 overflow-hidden bg-transparent">
            ...
            <button
                ...
                className="md:hidden absolute bottom-2 left-4 z-10 p-4 glass-dock rounded-full hover:bg-white/10 text-slate-300 hover:text-white transition-all active:scale-95 shadow-xl border border-white/10 group backdrop-blur-md bg-black/40"
            ...
            <button
                ...
                className="md:hidden absolute bottom-2 left-1/2 -translate-x-1/2 z-10 p-4 glass-dock rounded-full hover:bg-white/10 text-slate-300 hover:text-white transition-all active:scale-95 shadow-xl border border-white/10 group backdrop-blur-md bg-black/40 disabled:opacity-50 disabled:cursor-not-allowed"
            ...
            <div className="flex absolute bottom-2 right-4 md:bottom-32 md:right-6 flex-col space-y-3 z-10 scale-90 md:scale-100 origin-bottom-right">
